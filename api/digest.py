        ...
        for j in valid_listings:
            ...
            if score.recommendation in ["AUTO_APPLY", "REVIEW"]:
                ...
                parsed_jobs.append({
                    ...
                    "translucent_note": f"Note on this submission: This evaluation and alignment brief was generated by a custom agentic pipeline architected using Claude Code and Antigravity, calibrated with proprietary execution taxonomies. I use it to audit complex job descriptions against my actual 88,000 LOC operational background to ensure a {score.total_score}% fidelity match before human review."
                })
